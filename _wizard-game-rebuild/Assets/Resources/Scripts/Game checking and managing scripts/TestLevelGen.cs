...
public class TestLevelGen : MonoBehaviour
{
   ...
   public LayerMask layerMask;
    ...
    public void SpawnPlinthPair()
    {
        ...
        Vector3 plinthOrientation = new Vector3(0, Random.Range(30, 300), 0);
        GameObject a = Instantiate (Plinth, refRandom, Quaternion.Euler(plinthOrientation)) as GameObject;
        a.tag = ("Reference");
       ...
       // a.transform.SetParent(RefPlParent.transform);
        ...
        GameObject b = Instantiate(Plinth, attemptRandom, Quaternion.Euler(plinthOrientation)) as GameObject;
