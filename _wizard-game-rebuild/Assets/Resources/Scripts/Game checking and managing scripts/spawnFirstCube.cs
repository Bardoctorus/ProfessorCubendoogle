...
public class spawnFirstCube : MonoBehaviour {
    ...
    public void cubeSpawn(Vector3 refPlinthLocation)
    {
        ...
        Vector3 atCubeSpawnPoint = new Vector3(Random.Range(-testLevelGen.spawnLimits.x, testLevelGen.spawnLimits.x), 60f, Random.Range(-testLevelGen.spawnLimits.z, testLevelGen.spawnLimits.z)) +testLevelGen.GameAreaOffset;
        //instantiate them
        Vector3 randRot = new Vector3(Random.Range(40, 270), Random.Range(40, 270), Random.Range(40, 270));
        GameObject refCube = Instantiate(cube, refCubeSpawnPoint, Quaternion.identity)as GameObject;
        GameObject atCube = Instantiate(cube, atCubeSpawnPoint, Quaternion.Euler(randRot)) as GameObject;
